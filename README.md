...
Enables robust detection under weak contrast, cluttered backgrounds, and complex line shapes.
---
...
- ConvNeXt-mini Backbone — A lightweight backbone that enlarges the effective receptive field for structural line features.
...
```
The results will be saved under outputs/.
Modify the image path as needed to test your own images.
